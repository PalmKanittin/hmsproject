...
if($sql) {
echo "<script>alert('Medicalhistory info added Successfully');</script>";
...
<head>
    <title>Admin | Add Medical History</title>
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Admin | Add Medical History</h1>
                            </div>                   
                        </div>
                    </section>
                                            ...
                                            <div class="panel-body">
                                                <form role="form" name="adddoc" method="post"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <button type="button" class="btn btn-primary" onclick="addDrug()">Add</button> <br>                                                     
                                                    ...
                                                    <div class="form-group">
                                                        <label for="medicalhistorydate">Medicalhistory Date</label>
