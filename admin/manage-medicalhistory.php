...
<head>
    <title>Admin | Manage Medical History</title>
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Admin | Manage Medical History</h1>
                            </div>                           
                        </div>
                    </section>
                    ...
                    <div class="container-fluid container-fullw bg-white">
                        <div class="row">
                            <div class="col-md-12">
                                <h5 class="over-title margin-bottom-15"><a href="add-medicalhistory.php" class="btn btn-primary">Make Medical History</a></h5>
                                ...
                                <table class="table table-hover" id="sample-table-1">
                                    ...
                                    <tbody>
                                    <?php
                                        $sql = "SELECT medicalhistory.id AS mn_id, doctors.firstname AS doctor_fname, doctors.lastname AS doctor_lname, users.firstname AS user_fname, users.lastname AS user_lname, GROUP_CONCAT(drugs.drugname) AS drugname, height, weight, bloodpressure, medicalhistorydate, details FROM medicalhistory
                                        ...
                                        if($_SESSION['search_term'] !== '') { 
                                            ...
                                            $sql .= " WHERE medicalhistory.id LIKE '%$search_term%' 
