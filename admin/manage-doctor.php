            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    ...
                    <div class="container-fluid container-fullw bg-white">                                        
                        <div class="row">
                            <div class="col-md-12">
                                <h5 class="over-title margin-bottom-15"><a href="add-doctor.php" class="btn btn-primary">Add Doctor</a></h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs">
                                                    ...
                                                    <a href="manage-doctor.php?id=<?php echo $row['id']?>&del=delete"
