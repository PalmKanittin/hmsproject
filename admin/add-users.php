...
if(isset($_POST['submit'])) {    
    ...
    if ($result_check_email->num_rows > 0) {
        ...
        $sql_insert_user = "INSERT INTO users (firstname, lastname, gender, phonenum, birthdate, address, congenital, drugallergy, email, password) 
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form role="form" name="addu" method="post" onSubmit="return valid();">                                              
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="firstname" class="form-control" placeholder="Enter Patient Name" required></input>
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="lastname">Patient lastname</label>
                                                        <input type="text" name="lastname" class="form-control"placeholder="Enter Patient Lastname" required></input>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="phonenum" class="form-control" pattern="[0-9]*" placeholder="Enter Patient Phone Number" required></input>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="address" class="form-control" placeholder="Enter Patient address" required></input>
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="congenital">Congenital</label>
                                                        <input name="congenital" class="form-control" placeholder="Enter Patient congenital" required></input>
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="drugallergy">Drugallergy</label>
                                                        <input name="drugallergy" class="form-control" placeholder="Enter Patient drugallergy" required></input>
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="email">Email</label>
                                                        <input type="email" name="email" class="form-control" placeholder="Enter Patient Email" required></input>
                                                    </div>
