            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Admin | Manage Appointment</h1>
                            </div>                           
                        </div>
                    </section>
                    ...
                    <div class="container-fluid container-fullw bg-white">
                        <div class="row">
                            <div class="col-md-12">
                                <h5 class="over-title margin-bottom-15"><a href="add-appointment.php" class="btn btn-primary">Make Appointment</a></h5>
                                ...
                                <table class="table table-hover" id="sample-table-1">
                                    ...
                                    $sql = "SELECT appointment.id AS mn_id, doctors.firstname AS doctor_fname, doctors.lastname AS doctor_lname, users.firstname AS user_fname, users.lastname AS user_lname, appointmentdate, details FROM appointment
                                            LEFT JOIN users ON users.id = appointment.id_users 
                                            LEFT JOIN doctors ON doctors.id = appointment.id_doctor"; // ใส่ ; เพื่อจบคำสั่ง SQL นี้

                                    if($_SESSION['search_term'] !== '') { // เช็คว่ามีการค้นหาหรือไม่
                                        $search_term = $_SESSION['search_term'];
                                        $sql .= " WHERE appointment.id LIKE '%$search_term%' 
                                    ...
                                    if(mysqli_num_rows($result) > 0) {
                                        ...
                                        while($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo "<td>".$row['appointmentdate']."</td>"; // แก้เป็น medicalhistorydate ถ้ามีคอลัมน์นี้ในตาราง
