                                    ...
                                    <div class="panel-body">
                                        ...
                                        <p class="cl-effect-1">
                                            ...
                                            <?php 
                                                ...
                                                $sql = "SELECT COUNT(*) AS total_appointment FROM appointment WHERE id_users = ".$_SESSION['id'];
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <p class="links cl-effect-1">
                                            ...
                                            <?php 
                                                ...
                                                $sql = "SELECT COUNT(*) AS total_medicalhistory FROM medicalhistory WHERE id_users = ".$_SESSION['id'];
                                                $result = mysqli_query($conn, $sql);
