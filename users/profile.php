...
$sql=mysqli_query($conn,"Update users set firstname='$firstname', lastname='$lastname', gender='$gender', phonenum='$phonenum', birthdate='$birthdate', address='$address', congenital='$congenital', drugallergy='$drugallergy', password='$password' where id='".$_SESSION['id']."'");
if($sql)
{
                                    ...
                                    <div class="col-lg-8 col-md-12">
                                        <div class="panel panel-white">
                                            <div class="panel-body">
                                                <?php 
												include('../include/config.php');
												$sql = mysqli_query($conn,"select * from users where users.id='".$_SESSION['id']."'");
												while($data=mysqli_fetch_array($sql))
												{
												?>
                                                <h4>User <?php echo htmlentities($data['firstname']);?> Profile</h4>                   
                                                ...
                                                <form role="form" name="edit" method="post">
                                                    ...
                                                    <a href="dashboard.php" class="btn btn-danger" style="float: right; margin-right: 10px;">Cancel</a>
                                                </form>
                                                <?php } ?>
                                            </div>
                                        </div>
